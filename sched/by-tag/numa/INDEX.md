...
- [sched-20260806-014](../../2026/08/sched-20260806-014-sched-numa-hygon-remote-socket-distance-v2.md) `fix/medium/under_review` — Hygon 多 socket 平台 node_distance() 误报修正：改用 SLIT 实际 distance + 通用 normalize helper（Peter 要求），避免误伤其他平台。
