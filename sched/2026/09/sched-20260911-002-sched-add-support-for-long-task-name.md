...
patch_series:
  - version: v5
    ...
    date: 2026-08-28
    summary: 'comm 扩到 TASK_COMM_EXT_LEN=64，旧 UAPI 显式截断，新增 PR_{SET,GET}_EXT_NAME + copy_task_comm() + KUnit + selftests。'
    review_outcome: '截至 09-05 无任何回帖，无 review 标签。'
  - version: v6
    msgid: '<20260910-tonyk-long_name-v6-0-d70afbf194c5@igalia.com>'
    date: 2026-09-11
    summary: '修 security/ 编译错误；修 i915（%.*s 限宽）与 blktrace/intel_display_driver 缓冲区尺寸；修 KUnit 测试逻辑。'
