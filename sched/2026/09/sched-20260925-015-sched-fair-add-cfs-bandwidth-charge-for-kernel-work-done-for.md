# sched/fair: add cfs_bandwidth_charge() for kernel work done for a cgroup
...
contribution_opportunities:
  - kind: review
    description: "审读 debt 计费在多层祖先配额、burst、cpu.max 运行时修改下的正确性，以及 __refill_cfs_bandwidth_runtime 里 debt 归还的锁上下文"
  - kind: discussion
