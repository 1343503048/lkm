# Sleeping Owner Handling for Proxy Execution (v32)
...
patch_series:
  ...
  - version: v32
    ...
    date: '2026-09-22'
    summary: 'rebase 到 tip/sched/core；加入 K Prateek 的 activate-blocked-donor；采纳 Atul 复检 is_blocked；guard() 风格整理；修复 proxy_remove_from_sleeping_owner 竞态'
