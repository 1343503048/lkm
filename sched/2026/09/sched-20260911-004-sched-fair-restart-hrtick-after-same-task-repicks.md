# sched/fair: Restart hrtick after same-task repicks
...
patch_series:
  - version: v1
    ...
    date: 2026-08-13
    summary: '在 same-task repick 路径补 hrtick 重启；以 h_nr_runnable == h_nr_queued 抑制 delayed 实体误触发，新增 rq flag。'
    review_outcome: 'Zhan Xusheng 08-26 指出 delayed dequeue 条件缺陷与设计冗余；作者 09-11 接受并承诺 v2（h_nr_runnable > 1、去 rq flag）。'
