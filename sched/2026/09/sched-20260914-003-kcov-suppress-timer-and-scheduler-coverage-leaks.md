...
patch_series:
  ...
  - version: v3
    ...
    date: 2026-09-14
    summary: 'rebase mainline 22098763a10d；共享 flag helper + READ_ONCE/WRITE_ONCE/编译器屏障；try_to_wake_up pause 提前到 preempt 前；删 sched 补丁宽泛 Fixes；完整多架构/压测矩阵'
    review_outcome: 'Potapenko 对 4/6 提注释措辞建议（Callees instrumented with KCOV）；Peter 对 sched/core 侧最终认账仍待'
