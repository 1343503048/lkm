...
patch_series:
  - version: v1
    ...
    date: '2026-09-01'
    summary: 'scx_idle_test_and_clear_cpu() 中 __cpumask_clear_cpu -> cpumask_clear_cpu；Fixes: 48849271e661；1 文件 +1/-1'
    review_outcome: '09-01 当日无回帖；09-02 Andrea Righi 指出 cpumask_andnot/cpumask_or 同样非原子且该掩码设计上是 racy/self-correcting，要求改写为 best-effort 并给数据；作者 09-02 撤回，无 v2'
