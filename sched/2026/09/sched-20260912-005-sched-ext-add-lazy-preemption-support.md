...
patch_series:
  - version: v1
    ...
    date: 2026-09-12
    summary: 'SCX_ENQ_PREEMPT_LAZY/SCX_KICK_PREEMPT_LAZY/SCX_OPS_LAZY_SLICE_EXPIRY 让 BPF 调度器获得 fair 同款 lazy 抢占；拒绝立即+lazy 与 lazy+KICK_WAIT 组合；未知 kick flag 拒绝化；配套 623 行 kick selftest（fexit 探针校验 reschedule TIF）。瞄准 sched_ext/for-7.4。'
