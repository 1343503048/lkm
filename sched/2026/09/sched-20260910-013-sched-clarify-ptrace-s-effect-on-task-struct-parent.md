# sched: clarify ptrace's effect on task_struct->parent
...
patch_series:
  - version: v1
    ...
    date: "2026-09-10"
    summary: "把 include/linux/sched.h 中 parent 字段的单行注释扩成块注释，说明被 ptrace 期间由 tracer 临时替换；5 insertions / 1 deletion，No functional change。"
    review_outcome: "Oleg Nesterov 认为是 overdocumentation，先质疑是否需要更新该注释，随后给出单行替代措辞 ->real_parent or ptracer；作者当天认同。"
  - version: v2
    msgid: "<20260910133027.8453-1-zhangcoder@yeah.net>"
    date: "2026-09-10"
    summary: "改用 Oleg 提议的单行措辞，1 insertion / 1 deletion，新增 Suggested-by: Oleg Nesterov <oleg@redhat.com>。"
