...
authors: [Tejun Heo]
maintainers_involved: [Tejun Heo, Linus Torvalds]
current_version: v1
patch_series:
  - version: v1
    msgid: "<0f59915200a4239f27a624250c58dd6c@kernel.org>"
    date: '2026-09-01'
    summary: "sched_ext for v7.3-rc1 GIT PULL：dsq_move 所有权竞态导致的假性 abort、sleepable ops.cgroup_set_bandwidth()、示例调度器 timer/vtime 修复、cgroup CPU 旋钮文档化、tools 头同步（12 commits）"
...
contribution_opportunities:
  ...
  - kind: extend
    description: "sleepable cgroup_set_bandwidth() 的 capability marker 在 scx 工具侧尚无使用示例，可在 scx repo 补用例"
