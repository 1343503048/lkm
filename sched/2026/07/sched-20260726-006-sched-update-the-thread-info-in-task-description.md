...
patch_series:
  - version: v2
    ...
    date: 2026-06-09
    summary: "更新 THREAD_INFO_IN_TASK 的 Kconfig 描述：不再要求 arch 删除除 flags 外的所有 thread_info 字段，改为仅需移除 thread_info 中的 task_struct 指针字段；并完善 try_get_task_stack()/put_task_stack() 说明覆盖所有 stacktrace 函数。"
...
contribution_opportunities:
  - kind: review
    description: "核对补丁描述是否与各架构（arm64/x86/riscv/powerpc/loongarch）thread_info 现状一致，回帖 Reviewed-by 帮助推进"
  - kind: discussion
    description: "帮忙 Cc 合适的维护者或在列表回帖，避免这个小修复继续被淹没"
generated_at: "2026-07-27T01:10:00"
source_email_count: 1
related_articles: []
tags: [arm64, x86, riscv]
---
