...
lore_url: "未获取到"
authors: [Tao Cui]
maintainers_involved: [Tejun Heo, David Vernet]
current_version: v2
patch_series:
  - version: v1
  ...
  - version: v2
    ...
    date: 2026-08-14
    summary: "v2（2 patches）：修正 events sysfs 路径与 show_state 示例（drgn bool 打印为 False）；inlines.h 用 scx_bpf_sub_dispatch()；internal.h 命名 %SCX_DEQ_SCHED_CHANGE 而非删除未定义的 %SCX_DEQ_SAVE；internal.h 重述 @name 覆盖子调度器；rebase 到 sched_ext/for-7.3。"
