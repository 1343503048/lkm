...
patch_series:
  - version: v1
    msgid: "<unknown>"
    date: 2026-08-04
    summary: "update_task_scan_period() 在迁移失败（slow-scan 路径）early return 前未清零 locality 统计，导致同一迁移失败反复选 slow-scan 直到最大扫描周期。补上 memset 清零，与正常路径一致。Fixes: f307cd1a32fa，Cc: stable。"
