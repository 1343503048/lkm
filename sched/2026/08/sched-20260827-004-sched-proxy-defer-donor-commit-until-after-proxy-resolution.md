...
patch_series:
  ...
  - version: v2
    ...
    date: 2026-07-13
    summary: "put_prev_set_next_task()/rq_set_donor() 移到 proxy 分支之后；zap_balance_callbacks() 移入 proxy_resched_idle()"
    review_outcome: "未获取到"
  - version: v3
...
related_articles: [sched-20260810-007]
tags: [preempt, deadline]
---
