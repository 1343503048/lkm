...
patch_series:
  - version: v12
    ...
    date: 2026-08-17
    summary: "17 patch 系列：让 proxy execution 与 sched_ext 共存，通过 SCX_OPS_ENQ_BLOCKED 逐调度器能力把 blocked donor 交给 BPF 调度器。"
...
merge_assessment:
  likelihood: medium
  blocking_issues: [Tejun 对 owner CPU-pinned 行为有疑问待澄清；reject_dsq 与 core-sched deferred work 交互需进一步论证；系列体量巨大需多轮打磨]
  next_action: "等待 Andrea 出 v13 吸收本日 review 调整（去掉 SCX_TASK_ENQ_WAKEUP、内联条件、提前 PF_EXITING 等）。"
contribution_opportunities:
  - kind: review
    description: "评审 reject_dsq 与 generic deferred work flag 的交互设计，可提出更简洁方案。"
  - kind: testing
    description: "在开启 CONFIG_SCHED_PROXY_EXEC + CONFIG_SCHED_CLASS_EXT 的内核上跑 enq_blocked selftest 验证。"
generated_at: "2026-08-19T00:10:00"
source_email_count: 6
related_articles: [sched-20260817-001]
tags: [proxy_execution, sched_ext, sched/core]
---
