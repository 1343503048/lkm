...
patch_series:
  - version: v1
    ...
    date: '2026-08-28'
    summary: "在 set_delayed()/clear_delayed() 同步 nr_pref_llc_running 使其落在 runnable 域；account_llc_dequeue() 跳过仍 delayed 的任务避免二次递减；nr_llc_running 与 sd->llc_counts 保持 queued 语义"
...
related_articles: ["sched-20260827-018", "sched-20260830-003"]
tags: [load_balance, topology, cfs]
---
