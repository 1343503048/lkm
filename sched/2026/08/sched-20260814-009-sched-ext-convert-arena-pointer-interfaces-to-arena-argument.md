# sched_ext: Convert arena-pointer interfaces to __arena arguments
...
patch_series:
  - version: applied
    ...
    date: 2026-08-14
    summary: "Tejun 将 sched_ext 的 arena-pointer 接口转换为 __arena 参数（PATCHSET 1-3），已 Applied 到 sched_ext/for-7.3-arena-args。"
...
related_articles: ["sched-20260810-001"]
tags: [sched_ext]
---
