...
patch_series:
  - version: v1
    msgid: "<unknown>"
    date: 2026-08-19
    summary: "do_balance_callbacks() 中显式函数指针类型转换 (void (*)(struct rq *))head->func 是多余的——它不会改变 struct balance_callback 成员 (*func) 的函数类型，直接删除该强制转换。"
