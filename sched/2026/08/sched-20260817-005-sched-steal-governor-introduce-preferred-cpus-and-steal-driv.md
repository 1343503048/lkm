...
lore_url: "未获取到"
authors: [Shrikanth Hegde, K Prateek Nayak]
maintainers_involved: [Peter Zijlstra, K Prateek Nayak, Joel Fernandes]
current_version: v10
patch_series:
  - version: v10
    msgid: "<uid-43009@qq-imap>"
    date: 2026-08-17
    summary: "steal_governor v10 讨论回复：回应 32 位 ARM64 的 BUG()、迁移禁用下的抢占风暴、以及 task_rq_lock() 在 SRCU 读区内的 irq 死锁风险，给出修复方向与基准。"
...
merge_assessment:
  likelihood: medium
  blocking_issues: [irq 死锁修复需重新设计锁序、32 位 BUG 需 arch 条件编译、抢占风暴需细粒度额定]
  next_action: "等待 Shrikanth 出 v11 落实各项修复。"
contribution_opportunities:
  - kind: testing
    description: "在 32 位 ARM64 + 高 NUMA 节点机器上验证 steal 路径无 BUG/死锁；运行 hackbench/kernbench 看 steal 命中提升是否转化真实提速。"
generated_at: "2026-08-18T00:10:00"
source_email_count: 2
related_articles: []
tags: [sched/fair, numa, idle]
---
