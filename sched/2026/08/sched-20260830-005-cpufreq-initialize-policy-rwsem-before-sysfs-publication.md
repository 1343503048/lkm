...
patch_series:
  - version: v1
    ...
    date: 2026-08-30
    summary: "把 init_rwsem(&policy->rwsem) 提前到 kobject_init_and_add() 之前，消除用户态在 policy 半初始化时进入 sysfs 属性回调的窗口"
    review_outcome: "v1 当日无人回复；次日 Viresh Kumar Acked-by、Zhongqiu Han 认为 Fixes 应指向 2fc3384dc75b 并报出同一窗口的第二个漏洞"
...
related_articles: [sched-20260831-012]
tags: [cpufreq, crash]
---
