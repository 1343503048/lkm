...
patch_series:
  - version: v1
    ...
    date: '2026-08-28'
    summary: "task_tick 参数改名 queued->hrtick；for_each_sched_entity() 吸收 cfs_rq_of() 并新增 cfs_rq->backlink；task_h_load() 重做为在持 rq->lock 的记账点更新、限流改用 PELT 段"
...
related_articles: ["sched-20260824-009", "sched-20260831-003"]
tags: [cfs, cgroup, load_balance, sched_debug]
---
