...
patch_series:
  - version: v1
    ...
    date: 2026-08-15
    summary: "将 balance 时代命名统一改为 dispatch 术语：balance_one()->dispatch_one()，SCX_RQ_IN_BALANCE->SCX_RQ_IN_DISPATCH，并修正 dispatch 路径相关注释。"
...
merge_assessment:
  likelihood: high
  blocking_issues: [纯重命名 + 注释修正，无功能改动，通常直接收]
