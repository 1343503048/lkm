...
patch_series:
  - version: v1
    ...
    date: 2026-08-16
    summary: "把 CONFIG_EXT_SUB_SCHED 关闭时的 sub-cap kfunc EOPNOTSUPP 桩从 ext.c 移到 sub.c，使所有 sub kfunc 定义集中一处。"
...
related_articles: [sched-20260816-002]
tags: [sched_ext, cleanup]
---
