...
patch_series:
  - version: v5
    ...
    date: '2026-08-28'
    summary: "comm 由 16 扩到 TASK_COMM_EXT_LEN=64，旧 UAPI 显式截到 TASK_COMM_LEN，新增 PR_{SET,GET}_EXT_NAME + copy_task_comm() + KUnit + selftests；v5 相对 v4 把 helper 限定到 task_struct 并补 len 边界检查"
...
merge_assessment:
  ...
  next_action: "等 tracing/perf 侧对开销与 trace event 字段的意见；作者需补 task_struct 尺寸与 tracing 开销数据"
