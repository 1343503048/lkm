# rust: cpufreq: reject NULL from cpufreq_cpu_get()
...
authors: [Mehmet Koseoglu, Onur Özkan]
...
patch_series:
  - version: v1
    ...
    date: 2026-08-28
    summary: "功能版本：用 NonNull 拒 cpufreq_cpu_get() 的 NULL 返回并回 ENODEV，避免 from_err_ptr() 放过 NULL 导致 kobject_put() oops；含 KUnit 负控复现与 Validated on a VM as well 一句"
