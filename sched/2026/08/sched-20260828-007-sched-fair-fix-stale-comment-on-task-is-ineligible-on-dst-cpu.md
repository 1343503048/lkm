# sched/fair: Fix stale comment on task_is_ineligible_on_dst_cpu()
...
patch_series:
  - version: v1
    ...
    date: '2026-08-28'
    summary: "1/2 修正 task_is_ineligible_on_dst_cpu() 的失准注释并记录 eligibility 在源 rq 求值的理由；2/2 把 can_migrate_task() 否决清单补成 8 条并按测试顺序排列"
...
related_articles: ["sched-20260827-018", "sched-20260828-004"]
tags: [cfs, load_balance, eevdf]
---
