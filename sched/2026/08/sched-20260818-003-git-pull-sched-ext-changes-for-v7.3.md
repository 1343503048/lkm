...
patch_series:
  - version: v1
    ...
    date: 2026-08-18
    summary: "sched_ext for v7.3 GIT PULL：完成层级子调度的 CPU 委派、rescue execution、core scheduling 修复。"
