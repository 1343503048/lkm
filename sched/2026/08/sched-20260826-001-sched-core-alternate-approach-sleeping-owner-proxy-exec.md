...
patch_series:
  - version: v1
    msgid: unknown
    date: 2026-08-26
    summary: "16 篇 RFC，提出 proxy exec sleeping-owner 的替代处理方案，引入 is_linked 状态和 __task_rq_lock() 方案"
...
merge_assessment:
  likelihood: low
  blocking_issues: ["RFC PoC 不可 bisect", "spurious wakeup 开销未量化", "与原方案关系待厘清"]
