...
date: '2026-09-04'
subject: 'kernel/sched/ext/sub.c:288:16: sparse: sparse: incorrect type in argument
...
merge_assessment:
  ...
  next_action: 作者（提交 bb70e4fb626b 的 Tejun Heo）需在 scx_rescue_charge() 中对 rq->curr 做
    RCU 语义正确的读取，并附 Fixes/Reported-by/Closes 标签。
...
tags:
- sched_ext
title: 'kernel/sched/ext/sub.c:288:16: sparse: sparse: incorrect type in argument
  1 (different address spaces)'
layout: article
---
