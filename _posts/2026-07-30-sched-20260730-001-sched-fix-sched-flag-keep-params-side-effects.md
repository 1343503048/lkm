...
- version: v1
  ...
  date: 2026-07-30
  summary: 2-patch series fixing two side effects in __sched_setscheduler() when SCHED_FLAG_KEEP_PARAMS
    is set
...
- core_sched
- cgroup
title: 'sched/deadline: Skip bandwidth accounting with SCHED_FLAG_KEEP_PARAMS'
layout: article
---
