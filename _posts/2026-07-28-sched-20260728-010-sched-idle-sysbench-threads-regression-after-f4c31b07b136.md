...
- version: v1
  msgid: null
  date: 2026-07-02
  summary: '报告 f4c31b07b136 (sched: idle: Consolidate the handling of two special
    cases) 引入 Sysbench threads 回归'
  review_outcome: Rafael 确认可能是 tick 停止行为变化导致；Christian Loehel 参与分析；Oracle 确认 guest
    无 cpuidle driver
