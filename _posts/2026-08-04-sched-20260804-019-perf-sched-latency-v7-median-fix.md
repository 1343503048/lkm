...
- version: v7
  msgid: <unknown>
  date: 2026-08-04
  summary: 08-04 上有 review：为什么 global hist 排除 swapper 线程（建议改查 tid==0）；并讨论 --histogram/--time/--CPU
    输出细节。仍有小澄清待作者处理。
...
merge_assessment:
  likelihood: high
  blocking_issues:
  - swapper 排除逻辑改用 tid==0 的小修订待作者处理
...
related_articles:
- sched-20260803-010-perf-sched-latency-refine-outputs-unit-scaling-histogram-v7
tags:
- perf
- histogram
