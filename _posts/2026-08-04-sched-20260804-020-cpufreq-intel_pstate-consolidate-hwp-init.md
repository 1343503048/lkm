...
- version: v1
  msgid: <unknown>
  date: 2026-08-04
  summary: intel_pstate 重构 HWP P-state 初始化：引入 intel_pstate_get_hwp_pstates() 统一 HWP
    专属初始化，把 intel_pstate_hybrid_hwp_adjust() 的代码并入并移除其冗余 kerneldoc，使初始化路径更易读。声明无功能影响。
