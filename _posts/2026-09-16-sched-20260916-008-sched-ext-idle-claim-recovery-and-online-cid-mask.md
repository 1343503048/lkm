...
## 背景与问题
完整的背景与方案见 related_articles 中的 <a class="article-ref" href="/lkm/2026/09/15/sched-20260915-001-sched-ext-idle-claim-recovery-and-online-cid-mask.html">sched-20260915-001</a>。要点：sched_ext 的 qmap 示例调度器在 dispatch 路径上会丢失已分配的 idle claim，需要回收；此外，自带 CPU ID 映射的调度器此前无法获知哪些 CPU ID 在线，需要内核维护一个 online mask。

## 技术方案
系列含两枚补丁（idle claim recovery 与 online cid mask 维护），技术细节不变，见 <a class="article-ref" href="/lkm/2026/09/15/sched-20260915-001-sched-ext-idle-claim-recovery-and-online-cid-mask.html">sched-20260915-001</a>。
...
## 合入评估
*likelihood=merged*，*status=merged_tip*。已进入 `sched_ext/for-7.3-fixes` 分支，后续将随 v7.3-rc3 的 GIT PULL 进入 mainline（见 <a class="article-ref" href="/lkm/2026/09/16/sched-20260916-009-sched-ext-fixes-for-v7-3-rc3.html">sched-20260916-009</a>）。*blocking_issues*：无。*next_action*：等随 pull 请求进入 Linus 主线。
