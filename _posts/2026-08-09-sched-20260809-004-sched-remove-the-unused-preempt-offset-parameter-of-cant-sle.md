...
- version: merged
  ...
  date: 2026-08-09
  summary: tip-bot 自动报告 3 个已合入 tip/locking/core 的 commit，均为 sched 侧的抢占相关清理/修复：调整 preempt
    计数与抢占检查路径，统一若干调用点语义。
...
- preempt
- proxy_execution
title: 'sched: Remove the unused preempt_offset parameter of __cant_sleep()'
layout: article
---
