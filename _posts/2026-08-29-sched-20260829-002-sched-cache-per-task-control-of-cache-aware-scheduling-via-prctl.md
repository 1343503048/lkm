...
- version: v1
  ...
  date: 2026-08-29
  summary: 7 补丁 RFC：把 CAS 分组从 mm 解耦为引用计数的 sched_cache_group，新增 PR_SCHED_CACHE prctl（GET/CREATE/SHARE_FROM/DISABLE/ENABLE）与
    THP 式 always/advise/never debugfs 三态
...
merge_assessment:
  ...
  next_action: 补充真实用例与量化动机，完成 man page/selftest，就 prctl 与 sched_setattr 的取舍与 Qais
    Yousef 达成一致
