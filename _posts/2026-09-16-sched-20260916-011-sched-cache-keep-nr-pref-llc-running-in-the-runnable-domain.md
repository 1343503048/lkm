...
## 合入评估
*likelihood=medium*。方向明确、Peter 已参与且只提可执行的补标签意见，但尚未有最终 Ack，系列还涉及 3/4、4/4 的评审（见 <a class="article-ref" href="/lkm/2026/09/16/sched-20260916-012-sched-cache-decouple-sched-cache-group-from-mm.html">sched-20260916-012</a> / 013）。*blocking_issues*：缺 `Fixes:` 标签。*next_action*：作者补 `Fixes: 714059f79ff0` 并加后续移除 TODO 后重发。
