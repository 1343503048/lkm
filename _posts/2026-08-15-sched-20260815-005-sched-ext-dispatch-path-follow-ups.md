...
merge_assessment:
  likelihood: high
  blocking_issues:
  - 与 008/009 系列讨论 'task gone' 信号语义，需确认 005 与 009 的修复是否重复/互补
  next_action: 等待 Tejun 对 v2 的最终确认（其倾向用 ops.exit_task 由 BPF 侧处理）。
contribution_opportunities:
- kind: review
  description: 评审 v2 的 'task gone' 信号抢占点是否覆盖了所有 scx_dispatch/consume 路径，且与 009 的 exit_task
    修复不冲突。
...
- sched_ext
- crash
title: 'sched_ext: Dispatch path follow-ups'
layout: article
---
