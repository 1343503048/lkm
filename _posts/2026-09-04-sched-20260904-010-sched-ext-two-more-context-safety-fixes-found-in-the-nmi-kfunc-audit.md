...
merge_assessment:
  ...
  next_action: 等待 7.4 merge window 的 pull 通报；如需内部使用，自行确认 pick_idle_cpu_from_online_nodes()
    与 scx_locked_rq() 是否存在于内部树再排队回合。
...
tags:
- sched_ext
title: 'sched_ext: two more context-safety fixes found in the NMI kfunc audit'
layout: article
---
