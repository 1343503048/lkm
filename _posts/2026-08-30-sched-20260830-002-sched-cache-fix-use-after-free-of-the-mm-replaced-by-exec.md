...
- version: v1
  ...
  date: 2026-08-30
  summary: 在 exec_mm_put_old() 丢弃旧 mm 前插入 this_rq_lock_irq() 锁环充当穷人版 synchronize_rcu()，堵住
    account_mm_sched() 跨 CPU 读已释放 mm 的 UAF；附带在 perf 的 attach_task_ctx_data() 加 guard(rcu)()
