...
- version: v1
  ...
  date: 2026-05-22
  summary: 限制 SCHED_DEADLINE 的 revised wakeup rule 只应用于 running 状态的 dl_server（补丁正文发布于
    5 月，未在当日邮件缓存内）。
...
- deadline
- dl_server
title: 'sched/deadline: Use revised wakeup rule only for running dl_server'
layout: article
---
