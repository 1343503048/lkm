...
- kind: testing
  description: 写最小复现（FUSE daemon 在 flush 回调读 /proc/<pid>/stat，另一进程 exec 且关闭 O_CLOEXEC
    fd）并回帖，用于确认影响面与 stable 定级
- kind: review
...
title: deadlock from exec_update_lock and reading procfs
layout: article
---
