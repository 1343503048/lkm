...
- version: v1
  ...
  date: 2026-07-29
  summary: 无 cpuidle driver 路径恢复无条件 tick_nohz_idle_stop_tick()，修复 f4c31b07b136 引入的
    sysbench 回退；单 idle state 路径保留 got_tick 启发式。
...
- nohz
- regression
title: 'sched/idle: Stop the tick when no cpuidle driver is available'
layout: article
---
