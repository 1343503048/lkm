...
tags:
- core_sched
title: 'sched/core: Remove redundant core_sched_seq'
layout: article
---

## TL;DR

本文为增量更新，完整脉络见 related_articles 中的 <a class="article-ref" href="/lkm/2026/09/16/sched-20260916-020-sched-core-remove-redundant-core-sched-seq.html">sched-20260916-020</a>。Hui Su 的「删除冗余 core_sched_seq、用 core_pick 直接作 pending 标记」清理已被 Peter Zijlstra 合入 tip/sched/core（commit fbbc63fed0b09c8c5cf3972db8922ae98406ceec，09-25 12:45:58 +0200）。
