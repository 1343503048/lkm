...
- version: v1
  ...
  date: 2026-08-31
  summary: throttle_cfs_rq()/distribute_cfs_runtime() 的 cfs_rq->curr 读取点改为 cfs_rq->h_curr，修复
    85570f10a4c6 遗漏的逐层 current 转换
...
- kind: testing
  description: 多层 cpu.max 场景下采集 cpu.stat 的 nr_throttled/throttled_usec 与实际 runtime，验证
    1/2 是否消除配额超跑
- kind: review
