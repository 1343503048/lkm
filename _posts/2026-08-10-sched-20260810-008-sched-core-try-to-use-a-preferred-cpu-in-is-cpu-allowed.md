...
- version: v9
  ...
  review_outcome: Mete Durlu 在 8/10 针对 preferred CPU 与 is_cpu_allowed 的交互给出反馈；讨论 preferred
    CPU 与 root_domain/cpuset 约束的边界。
...
merge_assessment:
  likelihood: medium
  blocking_issues:
  - preferred CPU 与 cpuset/root_domain 约束的交互需澄清
