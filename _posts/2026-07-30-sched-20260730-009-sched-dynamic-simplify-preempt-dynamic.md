...
- version: v1
  ...
  review_outcome: Mete Durlu provided s390 test results showing ~1MB vmlinux size
    reduction
...
merge_assessment:
  likelihood: medium
  blocking_issues:
  - Need more arch testing and review
  next_action: Gather more arch test results
contribution_opportunities:
- kind: testing
  description: Test on other architectures (x86, arm64, riscv) and report size/behavior
    changes
...
tags:
- preempt
title: sched dynamic simplify preempt dynamic
layout: article
---
