...
- [sched-20260806-012](/lkm/2026/08/06/sched-20260806-012-fuse-wakeup-hints-to-scheduler.html) `feature/none/draft` — [RFC PATCH] fuse: give wakeup hints to the scheduler for synchronous requests
...
- [sched-20260803-008](/lkm/2026/08/03/sched-20260803-008-sched-adjust-cfs_bandwidth-layout-to-save-memory.html) `fix/low/under_review` — sched adjust cfs_bandwidth layout to save memory
- [sched-20260801-003](/lkm/2026/08/01/sched-20260801-003-sched-fair-sync-wakeups-target-wakers-core.html) `feature/none/under_review` — sched/fair: Let sync wakeups target the waker's core
