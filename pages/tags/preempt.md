...
- [sched-20260805-010](/lkm/2026/08/05/sched-20260805-010-cpufreq-schedutil-fix-rate-limit-overflow.html) `fix/high/under_review` — cpufreq: intel_pstate: Avoid using DESIRED_PERF when DEC is enabled
...
- [sched-20260804-018](/lkm/2026/08/04/sched-20260804-018-rseq-fix-hard-lockup-granted-time-slice-extension-v3.html) `bug/critical/under_review` — rseq fix hard lockup granted time slice extension v3
